...
import com.example.exam2512.fragment.FragmentNews
import com.example.exam2512.models.ModelCategory

class CatAdapter(
    private val array: ArrayList<ModelCategory>,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.item_category_cell, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            context.supportFragmentManager.beginTransaction()
                .replace(R.id.container, FragmentNews::class.java, bundle)
                .addToBackStack(null)
                .commit()
        }
    }
